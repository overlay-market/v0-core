...
import os
import json
from brownie import (OverlayTokenNew, ComptrollerShim, chain, interface, UniTest)
...
def uni_test(gov, rewards, accounts):
    ...
    unitest = rewards.deploy(UniTest, eth, usdc, usdc_eth, aave, eth, aave_eth)
