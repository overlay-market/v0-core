...
OI_CAP = 800000  # TODO: change to 0.1 * TOKEN_TOTAL_SUPPLY
AMOUNT_IN = 1
...
@pytest.fixture(scope="module")
def comptroller(gov, feed_infos, feed_owner):

    _, market_feed, depth_feed, quote = get_uni_feeds(feed_owner, feed_infos)

    # TODO: fix for updated shim constructor params
