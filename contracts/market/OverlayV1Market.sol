...
abstract contract OverlayV1Market is OverlayV1Governance {
    ...
    /// @return oi_ Total outstanding open interest on that side of the market.
    /// @return oiShares_ Total outstanding open interest shares on that side.
    /// @return priceFrame_ The price multiple comprised of the entry and exit
