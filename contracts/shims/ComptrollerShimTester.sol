...
import "../market/OverlayV1ComptrollerTester.sol";
import "../interfaces/IOverlayToken.sol";
import "../interfaces/IUniswapV3Pool.sol";
import "../libraries/UniswapV3OracleLibrary/UniswapV3OracleLibraryV2.sol";
import "../libraries/FixedPoint.sol";

contract ComptrollerShimTester is OverlayV1ComptrollerTester {
    ...
    function depth () public  override returns (uint depth_) {

        depth_ = staticCap;

    }

    function readFeed () public  returns (
        uint256 depth_
    ) { 
