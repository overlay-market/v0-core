...
// contract OverlayV1UniswapV3InverseMultiplexMarket is OverlayV1Market {
...
//     address public immutable ovlBase;
//     address public immutable ovlQuote;
//     uint128 internal immutable ovlBaseAmount;
//     bool internal immutable ovlBaseIs0;

//     address public immutable marketFeed;
//     address public immutable marketBase;
//     address public immutable marketQuote;
//     uint128 internal immutable marketBaseAmount;

//     constructor(
//         address _mothership,
//         address _ovlFeed,       // OVL/ETH
//         address _ovlQuote ,     // ETH
//         address _marketFeed,    // ETH/USD
//         address _marketQuote,   // USD
//         uint128 _baseAmount,
...
//         // immutables
//         ovlFeed = _ovlFeed;
//         ovlBaseIs0 = IUniswapV3Pool(_ovlFeed).token0() != _ovlQuote;
//         ovlBaseAmount = _ovlBaseAmount;

//         address _token0 = IUniswapV3Pool(_ovlFeed).token0();
//         address _token1 = IUniswapV3Pool(_ovlFeed).token1();

//         ovlBase = _token0 != _ovlQuote ? _token0 : _token1;
//         ovlQuote = _token0 == _ovlQuote ? _token0 : _token1;

//         ovlFeed = _ovlFeed;
//         marketBaseIs0 = IUniswapV3Pool(_marketFeed).token0() != _marketQuote;
...
//         marketBase = _token0 != _marketQuote ? _token0 : _token1;
//         marketQuote = _token1 == _marketQuote ? _token0 : _token1;
...
//             _marketLiquidity = marketBaseIs0
